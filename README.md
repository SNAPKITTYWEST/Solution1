...
The Pages workflow gates deployment on Linux (.NET, Wasm, frontend, browser tests) **and macOS Swift XCTest**. Screenshots are uploaded as workflow artifacts. The repository does not contain credentials or model weights.
